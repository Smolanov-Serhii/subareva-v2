...
$post_id = get_the_ID();
?>
<section class="banner banner-main <?php if (is_page(369)){ echo "new-banner"; }?>">
    <div class="banner__container">
        <div class="banner__left padding-left-part">
            ...
            if (get_field('podzagolovok_bloka', $post_id)){
                ?>
                <div class="new-banner__subtitle">
                    <?php echo the_field('podzagolovok_bloka', $post_id); ?>
                </div>
                <?php
            }
            ?>
            ...
            if (get_field('logotip_po_czenntru', $post_id)){
                ?>
                    <div class="new-banner__logo padding-left-part">
                        <img src="<?php echo the_field('logotip_po_czenntru', $post_id)?>" alt="">
                    </div>
