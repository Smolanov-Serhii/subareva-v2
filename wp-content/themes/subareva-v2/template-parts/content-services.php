        ...
        <div class="services__list">
            <a href="<?php echo get_home_url() . '/kosmetologiya' ?>" class="services__kosm services__group">
                ...
                if (wp_is_mobile()) {
                    ...
                    <div class="services__group-image">
                        <img src="<?php the_field('kartinka_dlya_uslug_kosmetologii', $post_id) ?>"
                             alt="<?php the_field('tekst_bloka_uslug_kosmetologii', $post_id) ?>">
                ...
                <div class="services__group-list">
                    ...
                    if (wp_is_mobile()) {
                        ?>
                        <div class="services__group-image">
                            <img src="<?php the_field('kartinka_dlya_bloka_uslug_kosmetologii_mobajl', $post_id) ?>"
                                 alt="<?php the_field('tekst_bloka_uslug_kosmetologii', $post_id) ?>">
                        </div>
                        <?php
                    }
            ...
            <a href="<?php echo get_home_url() . '/dentistry' ?>" class="services__stom services__group">
                ...
                if (wp_is_mobile()) {
                    ...
                    ?>
                    <div class="services__group-image">
                        <img src="<?php the_field('kartinka_dlya_bloka_uslug_stomatologii', $post_id) ?>"
                             alt="<?php the_field('tekst_bloka_uslug_stomalogii', $post_id) ?>">
                        <div class="services__group-name">
                ...
                <div class="services__group-list">
                    ...
                    if (wp_is_mobile()) {
                        ?>
                        <div class="services__group-image">
                            <img src="<?php the_field('kartinka_dlya_bloka_uslug_stomatologii_mobajl', $post_id) ?>"
                                 alt="<?php the_field('tekst_bloka_uslug_stomalogii', $post_id) ?>">
                        </div>
                        <?php
                    }
